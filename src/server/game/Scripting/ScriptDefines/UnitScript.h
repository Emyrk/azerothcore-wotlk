...
public:
     ...
     * @param overkill Damage exceeding the target's remaining health (0 if alive)
     */
    ...
    /**
     * @brief Called after an absorb aura (e.g. Power Word: Shield)
     *        absorbs part or all of incoming damage.
     *
     * Fires once per absorb aura per damage event inside
     * CalcAbsorbResist. Covers both school absorbs and mana shields.
     *
     * @param dmgInfo          Incoming damage context (attacker, victim,
     *                         spell, school). Damage field reflects the
     *                         remaining amount after this absorb.
     * @param absorbSpellInfo  The absorb aura's spell (e.g. Power Word: Shield)
     * @param absorbCaster     Unit that applied the absorb aura (may be nullptr)
